...
const TodoListItem = ({ data, style, removeSelf, ...props }) => {
  ...
  return (<div className="list-item" style={{ transition: `opacity ${TRANSITION_SPEED}ms ease-in-out`, opacity: opacity.toString(), ...style }} {...props}>
